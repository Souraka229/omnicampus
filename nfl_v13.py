"""
NFL Draft v13 - Maximum push with 20+ seeds
"""
...
print(f"CB 20-model: {roc_auc_score(y,cb_oof):.5f}")
...
print(f"XGB 4-seed: {roc_auc_score(y,xgb_oof):.5f}")
...
print(f"LGB 4-seed: {roc_auc_score(y,lgb_oof):.5f}")
...
# Aggressive Pseudo-labeling
for round in range(3):
    THRESH=0.88-round*0.01
    ...
    print(f"Pseudo r{round+1}: {p_auc:.5f} ({pmask.sum()} samples)")
